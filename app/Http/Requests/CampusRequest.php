...
class CampusRequest extends ApiFormRequest
{
    use DbDefault;
    /**
    ...
    {
        return [
            'code' => ['required','string','max:25',Rule::unique($this->getDbDefault('gn.campuses'))->ignore($this->id)],
            'name' => ['required','string','max:100',Rule::unique($this->getDbDefault('gn.campuses'))->ignore($this->id)],
