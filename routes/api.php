...
//    Route::post('logout',[AuthController::class,'logout']);
    ...
    Route::controller(RoomController::class)->group(function(){
        Route::get('room/index','indexRoom')->middleware('permission:List of rooms.');
        Route::get('room/{id}', 'showRoom')->middleware('permission:Search room by ID.');
        Route::get('room/status/{status}', 'showRoomByStatus')->middleware('permission:Search rooms by status.');
        Route::post('room/add', 'addRoom')->middleware('permission:Create a room.');
        Route::put('room/update/{id}', 'updateRoom')->middleware('permission:Update a room.');
        Route::delete('room/delete/{id}', 'deleteRoom')->middleware('permission:Delete a room.');
    });
    ...
    Route::controller(MeetingPatternController::class)->group(function(){
        ...
        Route::get('meeting_pattern/{day}/{hour}/{room_id}','showMeetingPattern')->middleware('permission:Search meeting pattern by day, hour, room ID.');
