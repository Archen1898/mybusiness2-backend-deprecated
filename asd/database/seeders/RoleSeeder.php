...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //Rooms
        $role1->givePermissionTo(['name'=>'List of rooms.']);
        $role1->givePermissionTo(['name'=>'Search room by ID.']);
        $role1->givePermissionTo(['name'=>'Search rooms by status.']);
        $role1->givePermissionTo(['name'=>'Create a room.']);
        $role1->givePermissionTo(['name'=>'Update a room.']);
        $role1->givePermissionTo(['name'=>'Delete a room.']);
        ...
        $role1->givePermissionTo(['name'=>'Search meeting pattern by day, hour, room ID.']);
