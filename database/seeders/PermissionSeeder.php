...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //Rooms
        Permission::create(['name'=>'List of rooms.']);
        Permission::create(['name'=>'Search room by ID.']);
        Permission::create(['name'=>'Search rooms by status.']);
        Permission::create(['name'=>'Create a room.']);
        Permission::create(['name'=>'Update a room.']);
        Permission::create(['name'=>'Delete a room.']);
        ...
        Permission::create(['name'=>'Search meeting pattern by day, hour, room ID.']);
